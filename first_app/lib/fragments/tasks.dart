...
class TheoryTaskList extends StatelessWidget {
  List<TheoryTask> theoryTasks;
  TheoryTaskList(this.theoryTasks);
  int _radComplex = 0;

  void _setRadComplex(int value) => () => {
        _radComplex = value,
      };
  @override
        ...
        body: new Container(
            child: new FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  return theoryTasks.isNotEmpty
                      ? new TheoryTaskList(theoryTasks)
